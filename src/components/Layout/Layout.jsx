...
import { getKilometerRange, saveCity, setIsBrowserSupported, setKilometerRange } from '@/redux/reuducer/locationSlice';
    ...
    useEffect(() => {
        const getSystemSettings = async () => {
            try {
                ...
                const min_range = data?.data.min_length
                const max_range = data?.data.max_length
                ...
                <>
                    {pathname === '/chat' ? (
                        <>
                            <MainHeader />
                            <AlertBanner
                                message="Welcome to Stageright! Check out our latest features and updates."
                                type="info"
                                dismissible={true}
                            />
                            {children}
